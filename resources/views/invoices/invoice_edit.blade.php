                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('invoice.update') }}" id="myForm">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <select name="client_id" id="client-select" class="form-select select2" aria-label="Default select example">
                                            ...
                                            @foreach ($clients as $client)
                                                <option value="{{ $client->id }}" data-payment-cycle="{{ $client->client_payment_cycle }}" {{ ($invoice->client_id == $client->id) ? 'selected' : null  }}>
                                                    {{ $client->client_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="po_no" class="form-control" type="text" value="{{ $invoice->po_no }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="invoice_no" id="invoice-no" class="form-control" type="text" value="{{ $invoice->invoice_no }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <textarea name="description" id="description" class="form-control" rows="5">{{ $invoice->description }}</textarea>
                                    </div>
                                </div>

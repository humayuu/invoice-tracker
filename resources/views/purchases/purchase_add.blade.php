                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('purchase.store') }}" id="myForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="date" id="purchase-date" name="purchase_date" value="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <select name="supplier_id" id="supplier-select" class="form-select select2" aria-label="Default select example">
                                            ...
                                            @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->id }}" data-payment-cycle="{{ $supplier->supplier_payment_cycle }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="purchase_invoice_no" id="purchase-invoice-no" class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="row mb-3">
